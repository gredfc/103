var Autobot = {
  title: 'GrepoBot',
  version: '5.1',
  domain: window['location']['protocol'] + 'https://cdn.jsdelivr.net/gh/gredfc/103@104/',
  scriptDomain: window['location']['protocol'] + 'https://cdn.jsdelivr.net/gh/gredfc/103@104/',
  botWnd: '',
  botPremWnd: '',
  botEmailWnd: '',
  facebookWnd: '',
